...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academic Specialization Category';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academic Courses Catalog';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    certification: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    course_banner: Schema.Attribute.Media<'images'>;
    course_code: Schema.Attribute.String & Schema.Attribute.Required;
    course_level: Schema.Attribute.Enumeration<
    ...
    course_thumbnail: Schema.Attribute.Media<'images'>;
    ...
    featured_course: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    lesson_count: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
    ...
    slug: Schema.Attribute.UID<'course_title'> & Schema.Attribute.Required;
    start_date: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what_you_learn: Schema.Attribute.RichText;
  };
}
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student Admission and Course Inquiries';
    displayName: 'Inquiry';
...
export interface ApiLecturerLecturer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Faculty Members & Course Instructors';
  ...
  attributes: {
    active_status: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
