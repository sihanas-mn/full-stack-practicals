...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    borrow_records: Schema.Attribute.Relation<
      'oneToMany',
      'api::borrow-record.borrow-record'
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::book.book'> &
      Schema.Attribute.Private;
    publication_year: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBorrowRecordBorrowRecord
  extends Struct.CollectionTypeSchema {
  collectionName: 'borrow_records';
  info: {
    displayName: 'Borrow Record';
    pluralName: 'borrow-records';
    singularName: 'borrow-record';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    book: Schema.Attribute.Relation<'manyToOne', 'api::book.book'> &
      Schema.Attribute.Required;
    borrow_date: Schema.Attribute.Date & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    due_date: Schema.Attribute.Date & Schema.Attribute.Required;
    lend_status: Schema.Attribute.Enumeration<
...
export interface ApiFineFine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    borrow_record: Schema.Attribute.Relation<
      'oneToOne',
      'api::borrow-record.borrow-record'
    > &
      Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::fine.fine'> &
      Schema.Attribute.Private;
    paid: Schema.Attribute.Boolean & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    fines: Schema.Attribute.Relation<'oneToMany', 'api::fine.fine'>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::borrow-record.borrow-record': ApiBorrowRecordBorrowRecord;
